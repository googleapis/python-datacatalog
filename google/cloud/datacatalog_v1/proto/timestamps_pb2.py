...
# source: google/cloud/datacatalog_v1/proto/timestamps.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/datacatalog_v1/proto/timestamps.proto",
...
_SYSTEMTIMESTAMPS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="create_time",
            full_name="google.cloud.datacatalog.v1.SystemTimestamps.create_time",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="update_time",
            full_name="google.cloud.datacatalog.v1.SystemTimestamps.update_time",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="expire_time",
            full_name="google.cloud.datacatalog.v1.SystemTimestamps.expire_time",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
