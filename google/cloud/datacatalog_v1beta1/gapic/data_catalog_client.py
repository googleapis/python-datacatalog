...
class DataCatalogClient(object):
    ...
    def search_catalog(
        ...
        Args:
            scope (Union[dict, ~google.cloud.datacatalog_v1beta1.types.Scope]): Required. The scope of this search request. A ``scope`` that has
    ...
    def list_entry_groups(
        ...
        Returns:
            A :class:`~google.api_core.page_iterator.PageIterator` instance.
            An iterable of :class:`~google.cloud.datacatalog_v1beta1.types.EntryGroup` instances.
            You can also iterate over the pages of the response
            using its `pages` property.
    ...
    def list_entries(
        ...
        Returns:
            A :class:`~google.api_core.page_iterator.PageIterator` instance.
            An iterable of :class:`~google.cloud.datacatalog_v1beta1.types.Entry` instances.
            You can also iterate over the pages of the response
            using its `pages` property.
