...
class Taxonomy(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            Note that taxonomy_id's are unique and generated by Policy
            Tag Manager.
        display_name (str):
    ...
    taxonomy_timestamps = proto.Field(proto.MESSAGE, number=5,
...
class PolicyTag(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            Both taxonomy_ids and policy_tag_ids are unique and
            generated by Policy Tag Manager.
        display_name (str):
