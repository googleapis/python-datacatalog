...
class PolicyTagManagerTransport(abc.ABC):
    ...
    @property
    def create_taxonomy(self) -> typing.Callable[
            [policytagmanager.CreateTaxonomyRequest],
            typing.Union[
                policytagmanager.Taxonomy,
                typing.Awaitable[policytagmanager.Taxonomy]
            ]]:
        raise NotImplementedError()

    @property
    def delete_taxonomy(self) -> typing.Callable[
    ...
    @property
    def update_taxonomy(self) -> typing.Callable[
    ...
    @property
    def list_taxonomies(self) -> typing.Callable[
    ...
    @property
    def get_taxonomy(self) -> typing.Callable[
    ...
    @property
    def create_policy_tag(self) -> typing.Callable[
            [policytagmanager.CreatePolicyTagRequest],
            typing.Union[
                policytagmanager.PolicyTag,
                typing.Awaitable[policytagmanager.PolicyTag]
            ]]:
        raise NotImplementedError()

    @property
    def delete_policy_tag(self) -> typing.Callable[
    ...
    @property
    def update_policy_tag(self) -> typing.Callable[
    ...
    @property
    def list_policy_tags(self) -> typing.Callable[
    ...
    @property
    def get_policy_tag(self) -> typing.Callable[
