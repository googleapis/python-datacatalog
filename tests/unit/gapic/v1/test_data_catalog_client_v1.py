...
from google.cloud.datacatalog_v1.proto import search_pb2
...
class TestDataCatalogClient(object):
    ...
    def test_create_entry_group(self):
        ...
        assert len(channel.requests) == 1
        expected_request = datacatalog_pb2.CreateEntryGroupRequest(parent=parent, entry_group_id=entry_group_id)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_entry_group(self):
        ...
        assert len(channel.requests) == 1
        expected_request = datacatalog_pb2.UpdateEntryGroupRequest(entry_group=entry_group)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_create_entry(self):
        ...
        display_name = 'displayName1615086568'
        description = 'description-1724546052'
        expected_response = {'name': name, 'linked_resource': linked_resource, 'user_specified_type': user_specified_type, 'user_specified_system': user_specified_system, 'display_name': display_name, 'description': description}
        ...
        assert len(channel.requests) == 1
        expected_request = datacatalog_pb2.CreateEntryRequest(parent=parent, entry_id=entry_id, entry=entry)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_entry(self):
        ...
        display_name = 'displayName1615086568'
        description = 'description-1724546052'
        expected_response = {'name': name_2, 'linked_resource': linked_resource, 'user_specified_type': user_specified_type, 'user_specified_system': user_specified_system, 'display_name': display_name, 'description': description}
        expected_response = datacatalog_pb2.Entry(**expected_response)
    ...
    def test_create_tag_template_field(self):
        ...
        is_required = True
        order = 106006350
        expected_response = {'name': name, 'display_name': display_name, 'is_required': is_required, 'order': order}
    ...
    def test_update_tag_template_field(self):
        ...
        is_required = True
        order = 106006350
        expected_response = {'name': name_2, 'display_name': display_name, 'is_required': is_required, 'order': order}
        expected_response = tags_pb2.TagTemplateField(**expected_response)
