...
class TestPolicyTagManagerClient(object):
    ...
    def test_list_taxonomies(self):
        ...
        expected_response = policytagmanager_pb2.ListTaxonomiesResponse(**expected_response)
    ...
    def test_create_policy_tag(self):
        ...
        expected_response = {'name': name, 'display_name': display_name, 'description': description, 'parent_policy_tag': parent_policy_tag}
    ...
    def test_list_policy_tags(self):
        ...
        expected_response = policytagmanager_pb2.ListPolicyTagsResponse(**expected_response)
    ...
    def test_get_policy_tag(self):
        ...
        description = 'description-1724546052'
        parent_policy_tag = 'parentPolicyTag2071382466'
        expected_response = {'name': name_2, 'display_name': display_name, 'description': description, 'parent_policy_tag': parent_policy_tag}
        expected_response = policytagmanager_pb2.PolicyTag(**expected_response)
