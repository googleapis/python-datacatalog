...
#   usage: python3 samples/v1/datacatalog_lookup_entry_sql_resource.py [--sql_name "[SQL Resource Name]"]
...
def sample_lookup_entry(sql_name):
    ...
    print(u"Entry type: {}".format(datacatalog_v1.EntryType(entry.type).name))
